...
public class GlideImageLoader {
    ...
    public RequestBuilder<Drawable> requestBuilder(Object obj) {
        this.mImageUrlObj = obj;
        return Glide.with(getContext())
                .load(obj)
                .listener(new RequestListener<Drawable>() {
    ...
    public void loadCircleImage(String url) {
        load(url, new RequestOptions().transform(new GlideCircleTransformation()));
    }
    public void loadCircleImage(String url,RequestOptions requestOptions) {
        load(url, requestOptions.transform(new GlideCircleTransformation()));
    }
    ...
    public void loadLocalCircleImage(int resId,RequestOptions requestOptions) {
