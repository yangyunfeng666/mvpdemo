...
public class UserRemoteTestDataSource extends BasePresenter<BaseUiInterface> implements UsersDataSource {


 public UserRemoteTestDataSource(BaseUiInterface mUiInterface) {
  super(mUiInterface);
 }
