...
import com.yunsoft.mvpdemo.activity.DaggerDependenciesComponentActivity;
...
public interface NetCommponent {
 void inject(DaggerDependenciesComponentActivity Activity);//这里不能写父类比如 Activity 只能写注入的那个类
}
